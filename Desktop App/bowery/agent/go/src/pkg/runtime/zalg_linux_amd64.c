...
#line 13 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
static bool use_aeshash; 
#line 19 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 29 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
b = a; 
hash = M0 ^ *h; 
while ( s > 0 ) { 
hash = ( hash ^ *b ) * M1; 
...
#line 39 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 49 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
runtime·memprint ( uintptr s , void *a ) 
{ 
uint64 v; 
#line 54 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
v = 0xbadb00b; 
switch ( s ) { 
case 1: 
v = * ( uint8* ) a; 
...
#line 72 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 82 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 91 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 99 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 106 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 117 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 124 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 135 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 142 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 153 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 160 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 171 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 178 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 191 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 198 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 205 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
runtime·c64equal ( bool *eq , uintptr s , void *a , void *b ) 
{ 
Complex64 *ca , *cb; 
#line 210 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
USED ( s ) ; 
ca = a; 
cb = b; 
*eq = ca->real == cb->real && ca->imag == cb->imag; 
} 
#line 216 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
runtime·c128equal ( bool *eq , uintptr s , void *a , void *b ) 
{ 
Complex128 *ca , *cb; 
#line 221 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
USED ( s ) ; 
ca = a; 
cb = b; 
*eq = ca->real == cb->real && ca->imag == cb->imag; 
} 
#line 232 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
runtime·f32hash ( uintptr *h , uintptr s , void *a ) 
{ 
uintptr hash; 
float32 f; 
#line 238 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
USED ( s ) ; 
f = * ( float32* ) a; 
if ( f == 0 ) 
hash = 0; 
...
#line 249 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
float64 f; 
uint64 u; 
#line 256 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
USED ( s ) ; 
f = * ( float64* ) a; 
if ( f == 0 ) 
hash = 0; 
...
#line 272 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 280 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 288 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 303 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 310 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
runtime·strequal ( bool *eq , uintptr s , void *a , void *b ) 
{ 
intgo alen; 
byte *s1 , *s2; 
#line 316 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
USED ( s ) ; 
alen = ( ( String* ) a ) ->len; 
...
#line 331 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 338 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 351 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 358 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 365 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 372 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 385 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 392 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 399 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 406 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 419 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 428 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
...
#line 438 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
Alg 
runtime·algarray[] = 
{ 
...
#line 469 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
byte runtime·aeskeysched[HashRandomBytes]; 
#line 471 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
runtime·hashinit ( void ) 
{ 
if ( NaCl ) 
return; 
#line 478 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
...
#line 493 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
runtime·get_random_data ( &rnd , &n ) ; 
if ( n > HashRandomBytes ) 
n = HashRandomBytes; 
runtime·memmove ( runtime·aeskeysched , rnd , n ) ; 
if ( n < HashRandomBytes ) { 
#line 499 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
...
#line 509 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
void 
runtime·equal ( Type *t , ... ) 
{ 
byte *x , *y; 
bool *ret; 
#line 515 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
...
{
#line 522 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
...
runtime·haveGoodHash(bool res)
{
	res = 0;
	FLUSH(&res);
#line 527 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
...
runtime·stringHash(String s, uintptr seed, uintptr res)
{
	res = 0;
	FLUSH(&res);
#line 531 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
...
runtime·bytesHash(Slice s, uintptr seed, uintptr res)
{
	res = 0;
	FLUSH(&res);
#line 536 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
...
runtime·int32Hash(uint32 i, uintptr seed, uintptr res)
{
	res = 0;
	FLUSH(&res);
#line 541 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
...
runtime·int64Hash(uint64 i, uintptr seed, uintptr res)
{
	res = 0;
	FLUSH(&res);
#line 546 "/home/vagrant/gocode/src/agent/go/src/pkg/runtime/alg.goc"
